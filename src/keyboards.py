...
def play_again_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🎰 Yana o'ynash", callback_data="play_again")],
            [
                InlineKeyboardButton(text="📊 Profil", callback_data="show_profile"),
                InlineKeyboardButton(text="⭐ Sotib olish", callback_data="show_store"),
            ],
        ]
    )
